...
const SkillCard = ({ skill }: Props) => {
  return (
    <div className=" bg-neutral-300 text-neutral-800 dark:bg-neutral-600 px-8 py-12 dark:text-neutral-50 rounded-xl flex flex-col justify-between gap-12 max-w-md mx-auto ">
